...
For the person use interacts with L<Term::ReadLine::Perl5> as a result
...
For the person who wants to use L<Term::ReadLine::Perl5>, this is a
pretty solid example of how to use this library. It contains (or will
contain) a multi-level dynamic completion, or interact with history.
